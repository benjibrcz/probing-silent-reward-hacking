...
**AUC ~0.7** (0.74 selected layer, 0.69 nested). Two checks make this airtight: (i) the monitor is
competent, not lazy — on *verbalized* hacks it catches **97%**; (ii) giving the monitor a fairer shot
doesn't help — a **stronger model (gpt-4.1) and a 6-shot monitor both stay at chance (AUC 0.48)**. So the
