...
before the action lands — is the harder, useful regime. *(fig1)*

![Figure 1: pre- vs post-emission AUC by layer.](figures/fig1_pre_vs_post.png) (I don't pool the two checkpoints: their
...
**3. It replicates on organism 2.** *(fig4)*

![Figure 4: two-organism headline.](figures/fig4_two_organism.png) Monitor-evasion is just as clean (keyword **0.00**, LLM
...
**4. Mechanism: an honest null.** *(fig3)*

![Figure 3: cross-checkpoint transfer collapses.](figures/fig3_transfer.png) Does the KL penalty hide the words or restructure the
